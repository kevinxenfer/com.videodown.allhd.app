...
public class Download_InstaActivity extends CdActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_insta);


        sAccessBtn = (LinearLayout) findViewById(R.id.sAccessBtn);
        ...
        this.sAccessBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent;
                StorageManager storageManager = (StorageManager) Download_InstaActivity.this.getSystemService(Context.STORAGE_SERVICE);
                String whatsupFolder = Download_InstaActivity.this.getWhatsupFolder();
                ...
                Download_InstaActivity insta_downloades_Activity = Download_InstaActivity.this;
                insta_downloades_Activity.startActivityForResult(intent, insta_downloades_Activity.REQUEST_ACTION_OPEN_DOCUMENT_TREE);
            }
        });
        populateGrid();
    }
...
//        this.swiperefresh.setVisibility(View.GONE);
    ...
    public String getWhatsupFolder() {
        MyUtils.RootDirectoryInstaShow.isDirectory();
        return "Download%2FStatusSaver%2FInsta";
    }
    ...
    public void getPosition(final int i, File file) {
        ...
        new MainAds().showInterAds(Download_InstaActivity.this, new InterAds.OnAdClosedListener() {
            @Override
            public void onAdClosed() {
                Intent intent = new Intent(Download_InstaActivity.this, FullViewActivity.class);
