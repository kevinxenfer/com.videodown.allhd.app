...
import com.videodown.allhd.app.Activity.StoryDownloader.ChingariActivity;
...
public class IntroChingariActivity extends CdActivityBase {
    AppCompatTextView txt_next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intro_chingari);
        ...
        txt_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new MainAds().showInterAds(IntroChingariActivity.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(IntroChingariActivity.this, ChingariActivity.class);
