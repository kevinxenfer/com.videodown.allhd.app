...
public class WhatsApp_downloads_Activity extends CdActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whats_app_downloads);
        ...
        findViewById(R.id.img_back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WhatsApp_downloads_Activity.this.onBackPressed();
            }
        });
        ...
        swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            public final void onRefresh() {
                WhatsApp_downloads_Activity.this.getAllFiles();
                WhatsApp_downloads_Activity.this.swiperefresh.setRefreshing(false);
            }
        });
        sAccessBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent;
                StorageManager storageManager = (StorageManager) WhatsApp_downloads_Activity.this.getSystemService("storage");
                String whatsupFolder = WhatsApp_downloads_Activity.this.getWhatsupFolder();
                ...
                intent.addFlags(128);
                intent.addFlags(64);
                WhatsApp_downloads_Activity whatsApp_downloads_Activity = WhatsApp_downloads_Activity.this;
                whatsApp_downloads_Activity.startActivityForResult(intent, whatsApp_downloads_Activity.REQUEST_ACTION_OPEN_DOCUMENT_TREE);
            }
        });
        populateGrid();
    }
...
//        this.swiperefresh.setVisibility(View.GONE);
    ...
    public String getWhatsupFolder() {
        MyUtils.downloadWhatsAppDir.isDirectory();
        return "Download%2FStatusSaver%2FWhatsapp";
    }
    ...
    public void getPosition(final int i, File file) {
        ...
        new MainAds().showInterAds(WhatsApp_downloads_Activity.this, new InterAds.OnAdClosedListener() {
            @Override
            public void onAdClosed() {
                Intent intent = new Intent(WhatsApp_downloads_Activity.this, FullViewActivity.class);
