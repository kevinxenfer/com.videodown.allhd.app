...
import com.videodown.allhd.app.Activity.StoryDownloader.ShareChatActivity;
...
public class IntroSharechatActivity extends CdActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_sharechat);
        ...
        txt_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new MainAds().showInterAds(IntroSharechatActivity.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(IntroSharechatActivity.this, ShareChatActivity.class);
