...
import com.videodown.allhd.app.Activity.StoryDownloader.InstagramSelectionActivity;
...
public class IntroInstaActivity extends CdActivityBase {
    AppCompatTextView txt_next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intro_insta);
        ...
        txt_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new MainAds().showInterAds(IntroInstaActivity.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(IntroInstaActivity.this, InstagramSelectionActivity.class);
