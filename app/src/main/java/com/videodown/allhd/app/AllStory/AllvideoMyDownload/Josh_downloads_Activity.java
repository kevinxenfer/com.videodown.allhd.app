...
public class Josh_downloads_Activity extends AppCompatActivity implements FileListClickInterface {
    ...
    File mediaPath = new File(Environment.getExternalStorageDirectory() + "/Download/StatusSaver/Josh");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_josh_downloads);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Josh_downloads_Activity.this.onBackPressed();
            }
        });
        ...
        this.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            public final void onRefresh() {
                Josh_downloads_Activity.this.getAllFiles();
                Josh_downloads_Activity.this.swiperefresh.setRefreshing(false);
            }
        });
        this.sAccessBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent;
                StorageManager storageManager = (StorageManager) Josh_downloads_Activity.this.getSystemService("storage");
                String whatsupFolder = Josh_downloads_Activity.this.getWhatsupFolder();
                ...
                intent.addFlags(128);
                intent.addFlags(64);
                Josh_downloads_Activity josh_downloads_Activity = Josh_downloads_Activity.this;
                josh_downloads_Activity.startActivityForResult(intent, josh_downloads_Activity.REQUEST_ACTION_OPEN_DOCUMENT_TREE);
            }
        });
        populateGrid();
    }
...
//        this.swiperefresh.setVisibility(View.GONE);
    ...
    public String getWhatsupFolder() {
        ...
        return "Download%2FStatusSaver%2FJosh";
    }
