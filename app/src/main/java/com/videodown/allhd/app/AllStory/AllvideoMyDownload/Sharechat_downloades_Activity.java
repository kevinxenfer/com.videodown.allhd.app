...
public class Sharechat_downloades_Activity extends CdActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sharechat_downloades);
        ...
        findViewById(R.id.img_back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Sharechat_downloades_Activity.this.onBackPressed();
            }
        });
        ...
        this.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            public final void onRefresh() {
                Sharechat_downloades_Activity.this.getAllFiles();
                Sharechat_downloades_Activity.this.swiperefresh.setRefreshing(false);
            }
        });
        this.sAccessBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent;
                StorageManager storageManager = (StorageManager) Sharechat_downloades_Activity.this.getSystemService("storage");
                String whatsupFolder = Sharechat_downloades_Activity.this.getWhatsupFolder();
                ...
                intent.addFlags(128);
                intent.addFlags(64);
                Sharechat_downloades_Activity sharechat_downloades_Activity = Sharechat_downloades_Activity.this;
                sharechat_downloades_Activity.startActivityForResult(intent, sharechat_downloades_Activity.REQUEST_ACTION_OPEN_DOCUMENT_TREE);
            }
        });
        populateGrid();
    }
...
//        this.swiperefresh.setVisibility(View.GONE);
    ...
    public String getWhatsupFolder() {
        MyUtils.RootDirectoryShareChatShow.isDirectory();
        return "Download%2FStatusSaver%2FShareChat";
    }
    ...
    public void getPosition(final int i, File file) {
        ...
        new MainAds().showInterAds(Sharechat_downloades_Activity.this, new InterAds.OnAdClosedListener() {
            @Override
            public void onAdClosed() {
                Intent intent = new Intent(Sharechat_downloades_Activity.this, FullViewActivity.class);
