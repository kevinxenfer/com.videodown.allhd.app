...
public class FB_downloads_Activity extends CdActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fb_downloads);
        ...
        findViewById(R.id.img_back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                FB_downloads_Activity.this.onBackPressed();
            }
        });
        ...
        this.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            public final void onRefresh() {
                FB_downloads_Activity.this.getAllFiles();
                FB_downloads_Activity.this.swiperefresh.setRefreshing(false);
            }
        });
        this.sAccessBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent;
                StorageManager storageManager = (StorageManager) FB_downloads_Activity.this.getSystemService("storage");
                String whatsupFolder = FB_downloads_Activity.this.getWhatsupFolder();
                ...
                intent.addFlags(128);
                intent.addFlags(64);
                FB_downloads_Activity fB_downloads_Activity = FB_downloads_Activity.this;
                fB_downloads_Activity.startActivityForResult(intent, fB_downloads_Activity.REQUEST_ACTION_OPEN_DOCUMENT_TREE);
            }
        });
        populateGrid();
    }
...
//        this.swiperefresh.setVisibility(View.GONE);
    ...
    public String getWhatsupFolder() {
        MyUtils.RootDirectoryFacebookShow.isDirectory();
        return "Download%2FStatusSaver%2FFacebook";
    }
    ...
    public void getPosition(final int i, File file) {
        ...
        new MainAds().showInterAds(FB_downloads_Activity.this, new InterAds.OnAdClosedListener() {
            @Override
            public void onAdClosed() {
                Intent intent = new Intent(FB_downloads_Activity.this, FullViewActivity.class);
